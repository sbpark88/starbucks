...
import { floating1, floating2, floating3 } from "../../utils/Images.js";

render($(".youtube .inner .objects"))(`
<img src=${floating1} alt="Icon" class="floating floating1">
<img src=${floating2} alt="Icon" class="floating floating2">
`);
...
<img src=${floating3} alt="Icon" class="floating floating3">
`);
